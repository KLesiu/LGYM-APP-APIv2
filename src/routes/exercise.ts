...
import { addExercise,addUserExercise,deleteExercise,updateExercise,getAllExercises,getExerciseByBodyPart, getAllGlobalExercises,getAllUserExercises,getExercise } from "../controllers/exerciseController";
